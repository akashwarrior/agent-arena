...
async function main() {
  ...
  const agentsData = [
    { id: "deepseek", name: "DeepSeek", color: "#60a5fa", accent: "#006ff6", totalGames: 42, wins: 14, losses: 20, draws: 8, winRate: 33.3 },
    { id: "claude", name: "Claude", color: "#f97316", accent: "#d37100", totalGames: 42, wins: 12, losses: 22, draws: 8, winRate: 28.6 },
    { id: "openai", name: "OpenAI", color: "#34d399", accent: "#007d2c", totalGames: 42, wins: 18, losses: 16, draws: 8, winRate: 42.9 },
    { id: "gemini", name: "Gemini", color: "#a78bfa", accent: "#5934ff", totalGames: 42, wins: 10, losses: 24, draws: 8, winRate: 23.8 },
    { id: "grok", name: "Grok", color: "#f43f5e", accent: "#bf0016", totalGames: 42, wins: 8, losses: 26, draws: 8, winRate: 19.0 },
  ];
